...
for train, test in kFold.split(imagenes, probabilidades):
    ...
    history = modelR3.fit(imagenes[train], probabilidades[train], epochs=30, batch_size=60)
    ...
    metricas = modelR3.evaluate(imagenes[test], probabilidades[test])
...
imagenesPrueba, probabilidadesPrueba = cargarDatos("../../dataset/test/grays/", numeroCategorias, cantidaDatosPruebas,
                                                   ancho, alto)
