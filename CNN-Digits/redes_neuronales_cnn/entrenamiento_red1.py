...
resultados=modelR1.evaluate(x=imagenesPrueba, y=probabilidadesPrueba)
...
resultadosEntrenamiento = modelR1.evaluate(x=imagenes, y=probabilidades)
...
y_pred = modelR1.predict(x=imagenesPrueba)
